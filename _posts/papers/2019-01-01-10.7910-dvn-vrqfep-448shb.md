...
link: https://doi.org/10.7910/dvn/vrqfep/448shb
categories: Publications
title_fr: replication_files.tar.gz
venue_fr: Harvard Dataverse
abstract_fr: Includes the code and data to replicate the main findings in the 
  articles
